...
THREE.EditorControls = function ( object, domElement ) {
	...
	function onMouseDown( event ) {
		...
		domElement.addEventListener( 'contextmenu', preventDefault, false );
		domElement.addEventListener( 'mousedown', onMouseDown, false );
		domElement.addEventListener( 'mousewheel', onMouseWheel, false );
		domElement.addEventListener( 'DOMMouseScroll', onMouseWheel, false ); // firefox

		this.clear = function() {
			domElement.removeEventListener( 'contextmenu', preventDefault, false );
	...
	function onMouseWheel( event ) {
        ...
        if(object instanceof THREE.OrthographicCamera ) {
            object.left -= (delta/10)*object.aspect;
            object.right += (delta/10)*object.aspect;
            object.top += delta/10;
            object.bottom -= delta/10;
